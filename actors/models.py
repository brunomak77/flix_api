...
NATION_CHOICES = (
    ...
    ("MA", "Morocco"), ("MZ", "Mozambique"), ("MM", "Myanmar (Burma)"),
    ("NA", "Namibia"), ("NR", "Nauru"), ("NP", "Nepal"),
    ("NL", "Netherlands"), ("NZ", "New Zealand"), ("NI", "Nicaragua"),
    ("NE", "Niger"), ("NG", "Nigeria"),
    ("MK", "North Macedonia (formerly Macedonia)"), ("NO", "Norway"),
...
class Actor(models.Model):
    ...
    nationality = models.CharField(
        max_length=100, choices=NATION_CHOICES, blank=True, null=True
        )
